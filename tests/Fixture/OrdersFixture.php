...
class OrdersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'delivery_date' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        'delete_at' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'total' => 1,
                'delivery_date' => '2023-01-28 11:14:09',
                'user_id' => 1,
                'update_at' => '2023-01-28 11:14:09',
                'created_at' => '2023-01-28 11:14:09',
                'delete_at' => '2023-01-28 11:14:09',
            ],
        ];
        parent::init();
    }
